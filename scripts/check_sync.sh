...
Examples:
  ./check_sync.sh --public-rpc https://rpc.stable.xyz
  ./check_sync.sh --compose-service stable-node --public-rpc https://rpc.stable.xyz
  CONTAINER=stable-node-1 PUBLIC_RPC=https://rpc.stable.xyz ./check_sync.sh
EOF
}
